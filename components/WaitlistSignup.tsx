    ...
    <div style={{ background: compact ? "transparent" : "#fff", border: compact ? "none" : "1.5px solid #e2e8f0", borderRadius: 12, padding: compact ? 0 : "24px 28px" }}>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" as const }}>
        ...
        <button
          ...
          style={{ background: status === "loading" ? "#d1d5db" : "#e63946", color: "#fff", border: "none", borderRadius: 8, padding: "10px 20px", fontSize: 14, fontWeight: 700, cursor: status === "loading" ? "not-allowed" : "pointer", whiteSpace: "nowrap" as const }}
        >
