...
const COLOURS = {
  ...
  red:   { bg: "linear-gradient(135deg, #fff1f2 0%, #fee2e2 100%)", border: "#fecdd3", leftBorder: "#e63946", icon: "🚫", text: "#881337", badgeBg: "#fee2e2", badgeText: "#881337", pulse: "flag-pulse-red" },
};
